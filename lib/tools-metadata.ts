...
const tools: ToolMeta[] = [
  ...
  },
  {
    ...
    zh: "股息率计算器",
    en: "Dividend Yield",
    zhDesc: "算股息率，模拟股息再投资的长期收益",
    enDesc: "Calculate dividend yield and simulate reinvestment returns",
    zhMetaDesc: "计算股息率与股息再投资收益。输入每股分红和股价自动计算，支持股息再投资长期模拟。免费在线股息率计算器，高股息策略必备工具。",
    enMetaDesc: "Calculate dividend yield and simulate dividend reinvestment returns. Free Dividend Yield calculator for income investors.",
    category: "calc",
  },
  {
    id: "roe-roic",
    zh: "ROE/ROIC分析器",
    en: "ROE/ROIC Analyzer",
    zhDesc: "净资产收益率和投入资本回报率分析，附带杜邦分解",
    enDesc: "ROE and ROIC analysis with DuPont decomposition",
    zhMetaDesc: "计算ROE（净资产收益率）和ROIC（投入资本回报率），附带杜邦分析拆解盈利驱动因素。免费在线ROE/ROIC分析器，巴菲特最关注的盈利能力指标。",
    enMetaDesc: "Calculate ROE and ROIC with DuPont decomposition. Free ROE/ROIC Analyzer for value investors.",
    category: "quant",
  },
  {
    id: "cost-basis",
    zh: "持仓成本计算器",
    en: "Cost Basis",
    zhDesc: "多次买入加权平均成本与浮盈浮亏分析",
    enDesc: "Weighted average cost basis with unrealized P&L",
    zhMetaDesc: "计算多次买入同一只股票的加权平均成本，支持部分卖出后的已实现盈亏计算。免费在线持仓成本计算器，每次做T、补仓后都能看清真实成本。",
    enMetaDesc: "Calculate weighted average cost basis across multiple purchases. Free Cost Basis calculator for tracking stock positions.",
    category: "calc",
  },
  {
    id: "dashboard",
