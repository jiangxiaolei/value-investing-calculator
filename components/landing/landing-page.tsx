...
const tools: Tool[] = [
  ...
  },
  {
    ...
    descZh: "计算ROE和ROIC，附带杜邦分析拆解盈利驱动因素",
    descEn: "ROE and ROIC calculation with DuPont decomposition",
    href: "/tools/roe-roic",
    icon: BarChart3,
    ready: true,
    new: true,
  ...
  // ── Investment Calculators ──
  {
    ...
    zh: "股息率计算器",
    en: "Dividend Yield",
    descZh: "算股息率，模拟股息再投资的长期收益",
    descEn: "Calculate dividend yield and simulate reinvestment returns",
  ...
  },
  {
    ...
    zh: "持仓成本计算器",
    en: "Cost Basis",
    descZh: "多次买入加权平均成本与浮盈浮亏分析",
    descEn: "Weighted average cost basis with unrealized P&L",
    href: "/tools/cost-basis",
    icon: Target,
    ready: true,
    new: true,
    category: "calc",
  },
  {
    ...
    descZh: "定投复利计算——收益曲线、通胀调整、逐年明细",
    descEn: "Compound interest with monthly contributions, inflation adjustment, yearly breakdown",
  ...
  },
  {
    ...
    descZh: "通胀对购买力的影响，内置1913年至今CPI数据",
    descEn: "Inflation's impact on purchasing power, CPI data since 1913",
  ...
  },
  {
    ...
    descZh: "分析持仓偏离度，自动生成买卖指令",
    descEn: "Analyze allocation deviations, auto-generate trade instructions",
